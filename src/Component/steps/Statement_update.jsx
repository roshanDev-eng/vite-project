...
const Statement_update = () => {
  ...
  const values = useSelector((state) => state.Transaction.statement[index]);
  ...
  const handleSubmitDeposit = () => {
    dispatch(updateField({ arrayname: "statement", updatedata: formData }));
  };
...
export default Statement_update;
